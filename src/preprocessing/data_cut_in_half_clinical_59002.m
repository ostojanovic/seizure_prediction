...
base_directory = 'patient_59002_extracted_seizures/59001102/data_clinical_59002_2';

load(strcat(path,base_directory,'/Data_clinical_13.mat'))
...
savename_1 = strcat(path,base_directory,'/Data_preictal_13.mat');
savename_2 = strcat(path,base_directory,'/Data_ictal_13.mat');
