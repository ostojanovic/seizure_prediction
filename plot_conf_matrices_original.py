...
"""
This script plots confusion matrices for the original set. 
"""

with open("/net/store/ni/projects/Data/intracranial_data/Freiburg_epilepsy_unit/classification_and_prediction/results/original-merged/11502/all_results_11502.txt") as f1:
    original_11502 = json.load(f1)

with open("/net/store/ni/projects/Data/intracranial_data/Freiburg_epilepsy_unit/classification_and_prediction/results/original-merged/25302_2/all_results_25302_2.txt") as f2:
    original_25302 = json.load(f2)

with open("/net/store/ni/projects/Data/intracranial_data/Freiburg_epilepsy_unit/classification_and_prediction/results/original-merged/59002_2/all_results_59002_2.txt") as f3:
    original_59002 = json.load(f3)

with open("/net/store/ni/projects/Data/intracranial_data/Freiburg_epilepsy_unit/classification_and_prediction/results/original-merged/62002_2/all_results_62002_2.txt") as f4:
    original_62002 = json.load(f4)

with open("/net/store/ni/projects/Data/intracranial_data/Freiburg_epilepsy_unit/classification_and_prediction/results/original-merged/97002_3/all_results_97002_3.txt") as f5:
    original_97002 = json.load(f5)

with open("/net/store/ni/projects/Data/intracranial_data/Freiburg_epilepsy_unit/classification_and_prediction/results/original-merged/109602/all_results_109602.txt") as f6:
    original_109602 = json.load(f6)

# original merged set
# confusion matrix svm: 11502
tp_svm_11502 = np.round(original_11502[1]["avg_true_positives_svm"],decimals=2)
fp_svm_11502 = np.round(original_11502[1]["avg_false_positives_svm"],decimals=2)
fn_svm_11502 = np.round(original_11502[1]["avg_false_negatives_svm"],decimals=2)
tn_svm_11502 = np.round(original_11502[1]["avg_true_negatives_svm"],decimals=2)
confusion_matrix_svm_11502 = [[tp_svm_11502,fp_svm_11502],[fn_svm_11502,tn_svm_11502]]

# confusion matrix rdf: 11502
tp_rdf_11502 = np.round(original_11502[1]["avg_true_positives_rdf"],decimals=2)
fp_rdf_11502 = np.round(original_11502[1]["avg_false_positives_rdf"],decimals=2)
fn_rdf_11502 = np.round(original_11502[1]["avg_false_negatives_rdf"],decimals=2)
tn_rdf_11502 = np.round(original_11502[1]["avg_true_negatives_rdf"],decimals=2)
confusion_matrix_rdf_11502 = [[tp_rdf_11502,fp_rdf_11502],[fn_rdf_11502,tn_rdf_11502]]

# confusion matrix svm: 25302
tp_svm_25302 = np.round(original_25302[1]["avg_true_positives_svm"],decimals=2)
fp_svm_25302 = np.round(original_25302[1]["avg_false_positives_svm"],decimals=2)
fn_svm_25302 = np.round(original_25302[1]["avg_false_negatives_svm"],decimals=2)
tn_svm_25302 = np.round(original_25302[1]["avg_true_negatives_svm"],decimals=2)
confusion_matrix_svm_25302 = [[tp_svm_25302,fp_svm_25302],[fn_svm_25302,tn_svm_25302]]

# confusion matrix rdf: 25302
tp_rdf_25302 = np.round(original_25302[1]["avg_true_positives_rdf"],decimals=2)
fp_rdf_25302 = np.round(original_25302[1]["avg_false_positives_rdf"],decimals=2)
fn_rdf_25302 = np.round(original_25302[1]["avg_false_negatives_rdf"],decimals=2)
tn_rdf_25302 = np.round(original_25302[1]["avg_true_negatives_rdf"],decimals=2)
confusion_matrix_rdf_25302 = [[tp_rdf_25302,fp_rdf_25302],[fn_rdf_25302,tn_rdf_25302]]

# confusion matrix svm: 59002
tp_svm_59002 = np.round(original_59002[1]["avg_true_positives_svm"],decimals=2)
fp_svm_59002 = np.round(original_59002[1]["avg_false_positives_svm"],decimals=2)
fn_svm_59002 = np.round(original_59002[1]["avg_false_negatives_svm"],decimals=2)
tn_svm_59002 = np.round(original_59002[1]["avg_true_negatives_svm"],decimals=2)
confusion_matrix_svm_59002 = [[tp_svm_59002,fp_svm_59002],[fn_svm_59002,tn_svm_59002]]

# confusion matrix rdf: 59002
tp_rdf_59002 = np.round(original_59002[1]["avg_true_positives_rdf"],decimals=2)
fp_rdf_59002 = np.round(original_59002[1]["avg_false_positives_rdf"],decimals=2)
fn_rdf_59002 = np.round(original_59002[1]["avg_false_negatives_rdf"],decimals=2)
tn_rdf_59002 = np.round(original_59002[1]["avg_true_negatives_rdf"],decimals=2)
confusion_matrix_rdf_59002 = [[tp_rdf_59002,fp_rdf_59002],[fn_rdf_59002,tn_rdf_59002]]

# confusion matrix svm: 62002
tp_svm_62002 = np.round(original_62002[1]["avg_true_positives_svm"],decimals=2)
fp_svm_62002 = np.round(original_62002[1]["avg_false_positives_svm"],decimals=2)
fn_svm_62002 = np.round(original_62002[1]["avg_false_negatives_svm"],decimals=2)
tn_svm_62002 = np.round(original_62002[1]["avg_true_negatives_svm"],decimals=2)
confusion_matrix_svm_62002 = [[tp_svm_62002,fp_svm_62002],[fn_svm_62002,tn_svm_62002]]

# confusion matrix rdf: 62002
tp_rdf_62002 = np.round(original_62002[1]["avg_true_positives_rdf"],decimals=2)
fp_rdf_62002 = np.round(original_62002[1]["avg_false_positives_rdf"],decimals=2)
fn_rdf_62002 = np.round(original_62002[1]["avg_false_negatives_rdf"],decimals=2)
tn_rdf_62002 = np.round(original_62002[1]["avg_true_negatives_rdf"],decimals=2)
confusion_matrix_rdf_62002 = [[tp_rdf_62002,fp_rdf_62002],[fn_rdf_62002,tn_rdf_62002]]

# confusion matrix svm: 97002
tp_svm_97002 = np.round(original_97002[1]["avg_true_positives_svm"],decimals=2)
fp_svm_97002 = np.round(original_97002[1]["avg_false_positives_svm"],decimals=2)
fn_svm_97002 = np.round(original_97002[1]["avg_false_negatives_svm"],decimals=2)
tn_svm_97002 = np.round(original_97002[1]["avg_true_negatives_svm"],decimals=2)
confusion_matrix_svm_97002 = [[tp_svm_97002,fp_svm_97002],[fn_svm_97002,tn_svm_97002]]

# confusion matrix rdf: 97002
tp_rdf_97002 = np.round(original_97002[1]["avg_true_positives_rdf"],decimals=2)
fp_rdf_97002 = np.round(original_97002[1]["avg_false_positives_rdf"],decimals=2)
fn_rdf_97002 = np.round(original_97002[1]["avg_false_negatives_rdf"],decimals=2)
tn_rdf_97002 = np.round(original_97002[1]["avg_true_negatives_rdf"],decimals=2)
confusion_matrix_rdf_97002 = [[tp_rdf_97002,fp_rdf_97002],[fn_rdf_97002,tn_rdf_97002]]

# confusion matrix svm: 109602
tp_svm_109602 = np.round(original_109602[1]["avg_true_positives_svm"],decimals=2)
fp_svm_109602 = np.round(original_109602[1]["avg_false_positives_svm"],decimals=2)
fn_svm_109602 = np.round(original_109602[1]["avg_false_negatives_svm"],decimals=2)
tn_svm_109602 = np.round(original_109602[1]["avg_true_negatives_svm"],decimals=2)
confusion_matrix_svm_109602 = [[tp_svm_109602,fp_svm_109602],[fn_svm_109602,tn_svm_109602]]

# confusion matrix rdf: 109602
tp_rdf_109602 = np.round(original_109602[1]["avg_true_positives_rdf"],decimals=2)
fp_rdf_109602 = np.round(original_109602[1]["avg_false_positives_rdf"],decimals=2)
fn_rdf_109602 = np.round(original_109602[1]["avg_false_negatives_rdf"],decimals=2)
tn_rdf_109602 = np.round(original_109602[1]["avg_true_negatives_rdf"],decimals=2)
